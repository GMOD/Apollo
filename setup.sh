...
( set -x;
  bin/cpanm -v --notest -l extlib DBD::Pg < /dev/null;
  bin/cpanm -v --notest -l extlib DBI DBD::Pg < /dev/null;
  bin/cpanm -v --notest -l extlib Crypt::PBKDF2 < /dev/null;
  bin/cpanm -v --notest -l extlib LWP::UserAgent < /dev/null;
  bin/cpanm -v --notest -l extlib JSON < /dev/null;
