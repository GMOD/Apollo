...
public abstract class AbstractExpression extends AbstractSimpleObject implements java.io.Serializable {
    ...
    public AbstractExpression(String uniquename, String md5checksum, String description, Set<ExpressionProperty> expressionProperties, Set<FeatureExpression> featureExpressions, Set<ExpressionImage> expressionImages, Set<ExpressionCVTerm> expressionCVTerms, Set<ExpressionPublication> expressionPublications) {
       this.uniquename = uniquename;
