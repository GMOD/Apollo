...
public abstract class AbstractAssayBiomaterial extends AbstractSimpleObject implements java.io.Serializable {
    ...
    public AbstractAssayBiomaterial(Biomaterial biomaterial, Assay assay, int rank) {
        this.biomaterial = biomaterial;
        this.assay = assay;
        this.rank = rank;
    }
    public AbstractAssayBiomaterial(Biomaterial biomaterial, Channel channel, Assay assay, int rank) {
       this.biomaterial = biomaterial;
...
public AbstractAssayBiomaterial generateClone() {
	AbstractAssayBiomaterial cloned = new AbstractAssayBiomaterial; 
