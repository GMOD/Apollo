...
public abstract class AbstractFeatureRange extends AbstractSimpleObject implements java.io.Serializable {
    ...
    public AbstractFeatureRange(Feature rightEndFeature, Feature leftStartFeature, Feature feature, FeatureMap featureMap) {
        this.rightEndFeature = rightEndFeature;
        this.leftStartFeature = leftStartFeature;
        this.feature = feature;
        this.featureMap = featureMap;
    }
    public AbstractFeatureRange(Feature rightEndFeature, Feature leftStartFeature, Feature feature, FeatureMap featureMap, Feature leftEndFeature, Feature rightStartFeature, String rangeString) {
       this.rightEndFeature = rightEndFeature;
       this.leftStartFeature = leftStartFeature;
       this.feature = feature;
       this.featureMap = featureMap;
...
public AbstractFeatureRange generateClone() {
	AbstractFeatureRange cloned = new AbstractFeatureRange; 
