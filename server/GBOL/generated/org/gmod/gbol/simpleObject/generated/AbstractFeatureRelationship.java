...
public abstract class AbstractFeatureRelationship extends AbstractSimpleObject implements java.io.Serializable {
    ...
    public AbstractFeatureRelationship(Feature objectFeature, Feature subjectFeature, CVTerm type, String value, int rank, Set<FeatureRelationshipProperty> featureRelationshipProperties, Set<FeatureRelationshipPublication> featureRelationshipPublications) {
       this.objectFeature = objectFeature;
       this.subjectFeature = subjectFeature;
       this.type = type;
       this.value = value;
