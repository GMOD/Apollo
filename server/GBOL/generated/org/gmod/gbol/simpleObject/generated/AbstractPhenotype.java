...
public abstract class AbstractPhenotype extends AbstractSimpleObject implements java.io.Serializable {
    ...
    public AbstractPhenotype(CVTerm observable, CVTerm attribute, CVTerm cvalue, CVTerm assay, String uniqueName, String value, Set<PhenotypeCVTerm> phenotypeCVTerms, Set<PhenotypeStatement> phenotypeStatements, Set<FeaturePhenotype> featurePhenotypes) {
...
public AbstractPhenotype generateClone() {
	AbstractPhenotype cloned = new AbstractPhenotype; 
