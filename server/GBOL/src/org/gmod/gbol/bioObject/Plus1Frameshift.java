...
/**Wrapper class representing a plus 1 frameshift.
 * 
 * @author elee
 *
 */

public class Plus1Frameshift extends Frameshift {
	 ...
	 */
	public Plus1Frameshift(FeatureProperty featureProperty, BioObjectConfiguration conf) {
	 ...
	 * @param conf - Configuration containing mapping information
	 */
	public Plus1Frameshift(Transcript transcript, int coordinate, BioObjectConfiguration conf) {
		super(new FeatureProperty(conf.getDefaultCVTermForClass("Plus1Frameshift"),
