...
/** Wrapper class representing an insertion. 
 * 
 * @author elee
 *
 */
...
public class Insertion extends SequenceAlteration {
	 ...
	 */
	public Insertion(Feature feature, BioObjectConfiguration conf) {
		super(feature, conf);
	}
	
	/** Alternate constructor to create an Insertion object without having to pre-create the underlying
	 ...
	 * @param uniqueName - String representing the unique name for this Insertion
	...
	public Insertion(Organism organism, String uniqueName, boolean analysis,
		...
		super(new Feature(
				conf.getDefaultCVTermForClass("Insertion"),
				null,
				organism,
				null,
				uniqueName,
