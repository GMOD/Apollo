...
/** Wrapper class representing a non canonical 3' splice site. 
 * 
 * @author elee
 *
 */

public class NonCanonicalThreePrimeSpliceSite extends SpliceSite {
	 ...
	 */
	public NonCanonicalThreePrimeSpliceSite(Feature feature, BioObjectConfiguration conf) {
		super(feature, conf);
	}

	/** Copy constructor.
	 * 
	 * @param spliceSite - NonCanonicalThreePrimeSpliceSite to create the copy from
	 * @param uniqueName - String representing the unique name for this non canonical 3' splice site
	 */
	public NonCanonicalThreePrimeSpliceSite(NonCanonicalFivePrimeSpliceSite spliceSite, String uniqueName) {
	 ...
	 * @param conf - Configuration containing mapping information
	 */
	public NonCanonicalThreePrimeSpliceSite(Organism organism, String uniqueName, boolean analysis,
			boolean obsolete, Timestamp dateAccessioned, BioObjectConfiguration conf) {
		super(new Feature(
				conf.getDefaultCVTermForClass("NonCanonicalThreePrimeSpliceSite"),
				null,
				organism,
				null,
				uniqueName,
