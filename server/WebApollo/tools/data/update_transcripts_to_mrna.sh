...
java -cp "$webapollo_dir/WEB-INF/classes:$webapollo_dir/WEB-INF/lib/*" org.bbop.apollo.web.tools.UpdateTranscriptToMrna -m $webapollo_dir/config/mapping.xml $args
