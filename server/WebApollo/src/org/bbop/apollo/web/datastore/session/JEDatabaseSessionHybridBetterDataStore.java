...
public class JEDatabaseSessionHybridBetterDataStore implements DataStore {
	...
	public JEDatabaseSessionHybridBetterDataStore(JEDatabase db, BioObjectConfiguration conf, Feature sourceFeature) {
		this.db = db;
		this.conf = conf;
