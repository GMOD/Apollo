class UrlMappings {
    ...
    static mappings = {
        ...
        "/track/json/${organismString}/${trackName}/${sequence}:${fmin}..${fmax}.json"(controller: "track", action: "json")
        "/track/json/${organismString}/${trackName}/?loc=${sequence}:${fmin}..${fmax}"(controller: "track", action: "json")
