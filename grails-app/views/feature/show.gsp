	...
	<body>
		...
		<div id="show-feature" class="content scaffold-show" role="main">
			...
			<ol class="property-list feature">
				...
				<g:if test="${featureInstance?.residues}">
				<li class="fieldcontain">
					<span id="residues-label" class="property-label"><g:message code="feature.residues.label" default="Residues" /></span>
					
						<span class="property-value" aria-labelledby="residues-label"><g:fieldValue bean="${featureInstance}" field="residues"/></span>
