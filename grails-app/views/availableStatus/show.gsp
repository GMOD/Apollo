		...
		<div id="show-availableStatus" class="content scaffold-show" role="main">
			...
			<ol class="property-list availableStatus">
				...
				<li class="fieldcontain">
					<span id="value-label" class="property-label"><g:message code="availableStatus.value.label" default="Value" /></span>
					
						<span class="property-value" aria-labelledby="value-label"><g:fieldValue bean="${availableStatusInstance}" field="value"/></span>
			...
			<g:form url="[resource:availableStatusInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${availableStatusInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
