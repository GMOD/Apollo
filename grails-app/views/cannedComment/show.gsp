...
<div id="show-cannedComment" class="content scaffold-show" role="main">
    ...
    <ol class="property-list cannedComment">
        ...
        <li class="fieldcontain">
            ...
            <span class="property-value" aria-labelledby="comment-label"><g:fieldValue bean="${cannedCommentInstance}"
                                                                                       field="comment"/></span>
        ...
        <li class="fieldcontain">
            ...
            <span class="property-value" aria-labelledby="featureTypes-label"><g:fieldValue bean="${cannedCommentInstance}"
                                                                                        field="featureTypes"/></span>
        ...
        <li class="fieldcontain">
            ...
            <span class="property-value" aria-labelledby="metadata-label"><g:fieldValue bean="${cannedCommentInstance}"
                                                                                        field="metadata"/></span>
