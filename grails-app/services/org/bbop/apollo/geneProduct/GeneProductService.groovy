...
class GeneProductService {
  ...
  JSONObject convertAnnotationToJson(GeneProduct geneProduct) {
    ...
    goObject.put("aspect", geneProduct.aspect)
    goObject.put("goTerm", geneProduct.goRef)
    goObject.put("goTermLabel", geneProduct.goRefLabel)
    goObject.put("geneRelationship", geneProduct.geneProductRelationshipRef)
    goObject.put("evidenceCode", geneProduct.evidenceRef)
    goObject.put("evidenceCodeLabel", geneProduct.evidenceRefLabel)
    goObject.put("negate", geneProduct.negate)
