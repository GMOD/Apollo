...
class IOServiceController extends AbstractApolloController {
    ...
    @RestApiParams(params = [
            ...
            , @RestApiParam(name = "region", type = "String", paramType = RestApiParamType.QUERY, description = "Highlighted genomic region to export in form Track:min..max  e.g., chr3:1001..1034")
    ]
    )
    @Timed
    def write() {
