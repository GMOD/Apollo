...
class FeatureEventServiceSpec extends Specification {
    ...
    void "feature events with splits can be undone"() {
        ...
        leftObject.uniquename = uniqueName1
        JSONObject rightObject = new JSONObject()
        rightObject.uniquename = uniqueName2
...
//        FeatureEvent currentFeature = service.findCurrentFeatureEvent(uniqueName2)[0]
    ...
    void "undo merge after an action on the other side"() {
        ...
        assert currentFeatureEventArray.last().operation == FeatureOperation.ADD_TRANSCRIPT
        ...
        featureEventList1 = service.getHistory(uniqueName1)
        featureEventList2 = service.getHistory(uniqueName2)
        FeatureEvent exonBoundariesFeatureEvent = currentFeatureEventArray.first()
        FeatureEvent addTranscriptFeatureEvent = currentFeatureEventArray.last()
