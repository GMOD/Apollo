...
class FeatureEventServiceIntegrationSpec extends IntegrationSpec {
    ...
    void "we can undo and redo a transcript split"() {
        ...
        String redoString = "{ \"track\": \"Annotations-Group1.10\", \"features\": [ { \"uniquename\": \"@TRANSCRIPT_1@\" } ], \"operation\": \"redo\", \"count\": 1}"
        ...
        requestHandlingService.redo(JSON.parse(undoString1))
