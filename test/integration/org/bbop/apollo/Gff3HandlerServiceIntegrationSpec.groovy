...
class Gff3HandlerServiceIntegrationSpec extends IntegrationSpec {
    ...
    void "write a GFF3 of a simple gene model"() {
        ...
        String addInsertionString = '{"operation":"add_sequence_alteration","username":"deepak.unni3@gmail.com","features":[{"non_reserved_properties": [{"tag": "justification", "value":"Sanger sequencing"}], "residues":"GGG","location":{"fmin":208499,"strand":1,"fmax":208499},"type":{"name":"insertion","cv":{"name":"sequence"}}}],"track":"Group1.10","clientToken":"123123"}'
        String pseudogene = '{ "track": "Group1.10", "features": [{"location":{"fmin":433518,"fmax":437436,"strand":1},"type":{"cv":{"name":"sequence"},"name":"pseudogene"},"children":[{"location":{"fmin":433518,"fmax":437436,"strand":1},"type":{"cv":{"name":"sequence"},"name":"transcript"},"name":"GB40815-RA","children":[{"location":{"fmin":433518,"fmax":433570,"strand":1},"type":{"cv":{"name":"sequence"},"name":"exon"}},{"location":{"fmin":436576,"fmax":436641,"strand":1},"type":{"cv":{"name":"sequence"},"name":"exon"}},{"location":{"fmin":437424,"fmax":437436,"strand":1},"type":{"cv":{"name":"sequence"},"name":"exon"}},{"location":{"fmin":433518,"fmax":437436,"strand":1},"type":{"cv":{"name":"sequence"},"name":"CDS"}}]}]}], "operation": "add_feature", "username": "colin.diesh@gmail.com" ,"clientToken":"123123"}'
        String repeat_region = '{ "track": "Group1.10", "features": [{"location":{"fmin":414369,"fmax":414600,"strand":0},"type":{"cv":{"name":"sequence"},"name":"repeat_region"},"name":"GB40814-RA"}], "operation": "add_feature", "username": "colin.diesh@gmail.com" ,"clientToken":"123123"}'
