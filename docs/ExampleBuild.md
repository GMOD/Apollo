...
wget https://github.com/GMOD/Apollo/archive/2.0.3.tar.gz 
mv 2.0.3.tar.gz Apollo-2.0.3.tar.gz
tar xf Apollo-2.0.3.tar.gz
...
# Clones a bunch of git submodules into apollo-2.0.3/src
...
#  ./apollo deploy
# Above creates this file: target/apollo-2.0.3.war
sudo cp target/apollo-2.0.3.war /var/lib/tomcat/webapps/apollo.war

# Prepare JBrowse data
# Add the FASTA assembly
~/src/Apollo-2.0.3/bin/prepare-refseqs.pl \
--fasta /research/dre/assembly/assembly1.fasta.gz \
--out ~/organisms/dre

# Add annotations
~/src/Apollo-2.0.3/bin/flatfile-to-json.pl \
