...
Free certificates can be found by using [certbot](https://certbot.eff.org/lets-encrypt/ubuntutrusty-apache).
...
Here is the most basic configuration for a reverse proxy with Apache.   
