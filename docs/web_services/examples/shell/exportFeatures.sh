...
#    --data "{\"type\":\"FASTA\", \"seqType\":\"genomic\", \"exportAllSequences\":\"true\", \"exportGff3Fasta\":\"true\", \"output\":\"text\", \"format\":\"gff3\", \"sequences\":[], \"username\":\"ndunn@me.com\", \"password\":\"demo\",\"organism\":\"Volvox\" }" ;
