...
#curl -b ${username}_cookies.txt -c ${username}_cookies.txt -e  "http://icebox.lbl.gov/WebApolloDemo/" -d "{ 'operation': 'get_features', 'tracks': ['Annotations-Group1.10']}" http://icebox.lbl.gov/WebApolloDemo/
