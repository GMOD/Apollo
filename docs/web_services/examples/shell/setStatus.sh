...
echo curl -H 'Content-type: application/json' -X POST ${url}/annotationEditor/setStatus -d "{'username': '${username}', 'password': '${password}', 'features': [{'uniquename': '${uniqueName}', 'status': '${status}'}], 'track': '${trackName}', 'organism': '${organism}'}"
curl -H 'Content-type: application/json' -X POST ${url}/annotationEditor/setStatus -d "{'username': '${username}', 'password': '${password}', 'features': [{'uniquename': '${uniqueName}', 'status': '${status}'}], 'track': '${trackName}', 'organism': '${organism}'}"
