...
String usageString = "\nUSAGE: delete_annotations_from_organism.groovy <options>\n" +
        ...
        "./delete_annotations_from_organism.groovy -organismname organism_name -sequences chr1,chr2 -destinationurl http://localhost:8080/Apollo\n" +
        "./delete_annotations_from_organism.groovy -organismid 123  -sequences chr1,chr2 -destinationurl http://localhost:8080/Apollo"
...
cli.sequences('Sequence names from the organism, comma-delimited (e.g., chr1,chr2,chr3)', required: true, args:1)
